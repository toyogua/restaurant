<h2 align="center">MESAS CON ORDENES </h2>
<hr>
...
<div class="row">
    ...
    <div class="col-md-2">
        <button style="cursor: pointer;" class="btn btn-danger  dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Filtrar
        </button>
