<h1 style="padding-top: 5px; text-align: center;">Productos Más Vendidos</h1>
<hr>
...
<h3 class="text-danger text-center">
    <?php if($this->session->flashdata('top')): ?>
        <?php echo($this->session->flashdata('top')); ?>
    <?php endif; ?>
</h3>
<?php $attributes = array('id' => 'miform'); ?>
<!--    <form  method="post" action="reportes/listar">-->
<?php echo form_open('reportes/listarTopProductos/', $attributes); ?>
...
<div class="row offset-3">
    <div class=" col-md-2">
    <input name="top" value="1" type="radio" id="radiotop" class="form-check-input">
    <label class="form-check-label" for="radiotop">Más vendidos</label>
    </div>

    <div class=" col-md-2">
        <input name="top" value="2" type="radio" id="radiotop" class="form-check-input">
        <label class="form-check-label" for="radiotop">Menos Vendidos</label>
    </div>
</div>
<hr>
<div class="row offset-3">
