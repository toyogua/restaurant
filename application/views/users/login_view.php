...
<div style="padding-top: 500px;" class="col-lg-7 container">

    <?php echo form_open('users/login', $attributes);?>
        <label class="text-center" for="email1">Ingresa al Sistema</label>
        ...
        <div class="inputGroup inputGroup1">
            ...
            <input name="username" type="text" id="email" class="email" maxlength="256"/>
        ...
        <div class="inputGroup inputGroup3">
            <button style="cursor: pointer;" id="login">Entrar</button>
        </div>
